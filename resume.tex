...
Worked under the supervision of \textit{Dr. Kelly Blincoe} to make improvements, to a semi-finished Git client, adding abstract graphical \linebreak view of commit history, adding interactive GUI enabling users to manipulate commits through dragging nodes of the commits tree
\end{flushleft}
