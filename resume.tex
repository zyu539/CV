...
\usepackage[margin=1in]{geometry} % set margin to 1inch as UMich Requested
...
\basicInfo{
  $\bullet$ Name: Yu Zi \hspace{1cm}
  $\bullet$ Program: Master's of Science in Engineering \hspace{1cm}
  $\bullet$ U-M ID: 00324211 \hspace{1cm}
}
