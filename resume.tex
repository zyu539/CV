...
\basicInfo{
  (+64) 21-1055274 $\bullet$
  zyu539@aucklanduni.ac.nz $\bullet$
  18 Konini Road, Hataitai, New Zealand
}
...
\begin{itemize}[parsep=0.5ex]
  \item \textbf{Programming Languages:} Python, Java, JavaScript, C, Matlab, Octave, R, C, Haskell (rank by proficiency)
%  \begin{itemize}
...
\begin{itemize}
    \item \textbf{Zi Y.}, Luo Y., Guang Z., Qi L., Wu T., Zhang X.,  ``Anomalous Taxi Route Detection System Based on Cloud Services,'' in CloudComp2019, \href{https://doi.org/10.1007/978-3-030-48513-9_20}{[Page]}
\end{itemize}
