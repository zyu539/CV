...
\begin{itemize}[parsep=0.5ex]
  \item \textbf{Average GPA:} \textit{\textbf{3.84} / 4}
\end{itemize}
...
\section{Skills}
\begin{itemize}[parsep=0.5ex]
  \item \textbf{Programming Languages:} \textbf{Java}, \textbf{Python}, Go, C++, C, JavaScript
  \item \textbf{Other Knowledge:} Spark, Kubernetes, Docker, Kafka, Samza, MySQL, HBase, MongoDB
...
\section{Honors}
\datedline{\textbf{\textit{Highest Distinction}} of Faculty of Heinz College, Carnegie Mellon University}{2022}
