...
\basicInfo{
  $\bullet$ Name: Yu Zi \hspace{0.4cm}
  $\bullet$ Program: Master's of Science in Engineering \hspace{0.4cm}
  $\bullet$ U-M ID: 00324211 \hspace{0.4cm}
}
...
\section{Researches}
\begin{flushleft}
\datedsubsection{\textbf{Improvements to a Git client based on NodeJS}}{\textit{Summer Research Intern}}
...
\end{itemize}
\datedsubsection{\textbf{Cloud-based Anomaly Route Detection System}}{\textit{Part IV Project Research}}
